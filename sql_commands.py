...
#             cursor.execute("INSERT INTO user_master (username, credentials, fname, lname, dob, sex, hostel, roomno, phone, emergency, email) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",(uname, cred, fname, lname, sex, hostel, roomno, phone, emergency, email))
